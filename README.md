...
- **Monte Carlo Validation (BUY Only)**: Vectorized simulations to estimate the probability of success for every BUY signal, penalizing high-risk setups. SELL orders bypass this check.
