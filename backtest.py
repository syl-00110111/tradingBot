...
def main(symbol: str, _id: str):
    ...
    # Charger les bougies une seule fois (TODO TEST variance temporelle 180 minutes)
    new_candles_df = pandas.DataFrame(df_candles.tail(180), columns=['timestamp', 'open', 'high', 'low', 'close', 'volume'])
